...
class Sphere_surface(object):
    ...
    """
    def __init__(self, number_of_cells: int, side_length: float, reflective_index: complex):
        """
...
if __name__ == "__main__":
    ...
    go.show_scattered_far_field(simulation, show_plots=True, 
                                 show_opts=[{'label':'scattered_far_field'}],
                                 save_plots=True, save_opts=None,
                                 save_data=False, data_format='hdf5', 
