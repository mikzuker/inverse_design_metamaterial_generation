...
class ResnetBlock(Module):
    ...
    def forward(self, x, film_gamma=None, film_beta=None, time_emb=None):
        ...
        h = self.block1(
            x, film_gamma=film_gamma, film_beta=film_beta, scale_shift=scale_shift
        )
...
class Unet1D(Module):
    def __init__(
        ...
        if self.use_film:
            ...
            self.num_film_layers = (
                2 * len(in_out) + 2 * len(in_out) + 2 + 1
            )  # down, up, mid, final
...
class GaussianDiffusion1D(Module):
    ...
    def visualize_denoising_process(
        self, shape, cond=None, save_every=50, specific_steps=None
    ):
        """
...
class Trainer1D(object):
    def __init__(
        ...
        *,
        ...
        assert has_int_squareroot(self.num_samples), (
            ...
            while self.step < self.train_num_steps:
                ...
                for _ in range(self.gradient_accumulate_every):
                    ...
                    if path is not None:
                        ...
                        with open(
                            path_to_save_loss / f"loss_{loss_number}.txt", "a"
                        ) as f:
